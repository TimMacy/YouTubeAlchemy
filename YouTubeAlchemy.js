...
(async function () {
    ...
    styleSheet.textContent = `
        ...
        html[dark] {
            ...
            --yt-spec-background: rgb(255 255 255 / .1);
        ...
        /* main CSS */
        #yt-alchemy-settings-modal {
            --NotebookLM-color: hsl(134, 61%, 40%);
            --ChatGPT-color: hsl(217, 91%, 59%);
            --copy-color: hsl(33, 100%, 50%);
            --lazy-color: hsl(51, 100%, 50%);
            --download-color: hsl(359, 88%, 57%);
            --settings-color: hsl(0, 0%, 100%);
        }
        ...
        .button-tooltip {
            ...
            padding: 6px 8px;
            position: fixed;
            position-anchor: var(--centanni-tooltip-anchor);
            inset: auto;
        ...
        .sub-panel-overlay {
            ...
            transition-timing-function: cubic-bezier(.18, .47, .3, .97);
            background-color: rgba(0, 0, 0, .5);
            font-family: "Roboto", "Arial", sans-serif;
            font-size: 9px;
            line-height: 1.2;
            ...
            .sub-panel {
                ...
                -moz-osx-font-smoothing: grayscale !important;
                translate: 0 10dvh;
                transition: translate .5s cubic-bezier(.18, .47, .3, .97);
        ...
        @keyframes CentAnni-btn-stroke {
            from {
                border-color: color-mix(in srgb, var(--yt-primary) 20%, transparent);
            }
        ...
        .CentAnni-btn-feedback-shape {
            ...
            &:focus:not(:active)::after {
                animation: CentAnni-btn-stroke 400ms cubic-bezier(.2, 0, .6, 1);
            }
        }
        ...
        .CentAnni-video-tabView {
            .CentAnni-tabView {
                ...
                border: 1px solid var(--yt-btn-hover);
                overflow: hidden;
                box-sizing: border-box;
                background-color: transparent;
                z-index: 10;
            ...
            #tab-2 {
                border-top: 1px solid var(--yt-btn-hover);
            }
                ...
                &[theater] {
                    ...
                    .CentAnni-tabView-tab {
                        ...
                        &.active {
                            ...
                            outline: 1px solid rgb(250 250 250 / .4);
                        }
                    }
                    ...
                    #title ytd-badge-supported-renderer:not([hidden]) {
                        bottom: 0;
                        transform: translate(48px, calc(100% + 5px));
                    }
                }
                ...
                &[default-layout] {
                    ...
                    #container.ytd-playlist-panel-renderer {
                        ...
                        ytd-playlist-panel-video-renderer[selected][use-color-palette] {
                            ...
                            #play-icon.ytd-playlist-panel-video-renderer,
                    ...
                    #title ytd-badge-supported-renderer:not([hidden]) {
                        bottom: unset;
                        transform: translate(48px, calc(500% + 12px));
                    }
                    ...
                    &[cinematics-active] #cinematics-container {
                        position: fixed;
                        inset: 0;
                    ...
                    .ytd-watch-flexy[target-id="engagement-panel-macro-markers-description-chapters"] h3.ytd-macro-markers-list-item-renderer {
                        line-clamp: 4;
                        -webkit-line-clamp: 4;
                        max-height: unset;
                    }
            ...
            .ytwMarkdownDivHostEnableDefaultStyling strong {
                color: var(--CentAnniRed);
            }
            ...
            &.CentAnni-style-max-panel {
                ...
                ytd-app:not([fullscreen]) {
                    --ytd-masthead-height-absolute: 50px !important;
                    --ytd-masthead-height: 50px !important;
                    --ytd-toolbar-height: 50px !important;
        ...
        .CentAnni-style-watched-later-header {
            ytd-browse[page-subtype="playlist"][role="main"] ytd-item-section-renderer > #header {
                display: none;
            }
            ...
            ytd-two-column-browse-results-renderer.ytd-browse[page-subtype="playlist"][role="main"] {
        ...
        ytd-browse[page-subtype="home"][role="main"] #contents.ytd-rich-grid-renderer {
            justify-content: center;
        }
        ...
        .CentAnni-style-square-design {
            ...
            ytd-browse[page-subtype="subscriptions"][role="main"] {
            ...
            ytd-browse[page-subtype="channels"][role="main"] {
                ...
                #icon-button #interaction .yt-interaction {
                    border-radius: 50% !important;
                }
            }
        ...
        .CentAnni-style-compact-layout {
            ...
            ytd-browse[page-subtype="hashtag-landing-page"][role="main"] {
        ...
        :is(.CentAnni-style-compact-layout, .CentAnni-style-compact-layout-video) {
            ...
            yt-icon-button.dropdown-trigger.ytd-menu-renderer#button,
        ...
        .CentAnni-style-hide-news-home {
            ytd-browse[page-subtype="home"][role="main"] ytd-rich-grid-renderer:not([is-filtered-feed]) ytd-rich-section-renderer:has(#rich-shelf-header yt-icon#icon[hidden]):has(#rich-shelf-header yt-img-shadow#avatar[hidden]):has(#subtitle),
            ytd-browse[page-subtype="home"][role="main"] ytd-rich-grid-renderer:not([is-filtered-feed]) ytd-rich-section-renderer:has(ytd-rich-shelf-renderer[elements-per-row="3"][show-bottom-divider][has-expansion-button][restrict-contents-overflow] #subtitle:not(:empty)),
            ytd-browse[page-subtype="home"][role="main"] ytd-rich-grid-renderer:not([is-filtered-feed]) ytd-rich-section-renderer:has(ytd-rich-shelf-renderer[elements-per-row="3"][show-bottom-divider][restrict-contents-overflow] #top-level-buttons-computed button) {
                display: none;
            }
        }
        ...
        html.CentAnni-style-selection-color ::selection {
            color: contrast-color(var(--selectionColor));
        ...
        ytd-browse[page-subtype="channels"][role="main"] {
            ...
            #CentAnni-default-channel-page-btn {
                grid-area: 1 / 1;
                min-width: 0;
            }
    ...
    function showSettingsModal() {
        ...
        modal.classList.add('CentAnni-overlay', 'active');
        ...
        resetButton.onclick = async () => {
            ...
            try {
                ...
                window.closeAlchemySettingsModal(true);
                showNotification('Settings have been reset to default!', true);
        ...
        function setupModalHandlers(modal) {
            ...
            window.closeAlchemySettingsModal = (reload = false) => {
                if (reload) modal.classList.add('reload');
    ...
    async function saveSettings() {
        ...
        try {
            await GM.setValue('USER_CONFIG', USER_CONFIG);
            window.closeAlchemySettingsModal(true);
            showNotification('Settings have been updated!', true);
            setTimeout(() => location.reload(), 1000);
        } catch (error) {
            ...
            reader.onload = (event) => {
                ...
                try {
                    ...
                    if (typeof importedConfig === 'object' && importedConfig !== null) {
                        ...
                        window.closeAlchemySettingsModal(true);
                        showNotification('Settings have been imported.', true);
                        setTimeout(() => location.reload(), 1000);
                    } else {
    ...
    // helper to save a default page for channels
    async function saveChannelDefaultPage() {
        if (!channelHandleURL || !isChannelPage) return;

        const currentChannelPage = window.location.pathname.match(/^\/(?:@[^/]+|channel\/[^/]+)(?:\/([^/]+))?/)?.[1] || 'featured';
        const saved = Object.entries(USER_CONFIG.channelDefaultPages).map(([c, p]) => `${c}: ${p}`).join(' | ');
        const input = window.prompt(`Save ${currentChannelPage} as the default page for ${channelHandleURL}?\n\nType "reset" to remove the saved page for this channel.\nType "DELETE ALL" to remove all saved values.\n\n— Saved Pages —\n${saved || 'None'}`);

        if (input === null) return;
        if (input === 'reset') {
            delete USER_CONFIG.channelDefaultPages[channelHandleURL];
            await GM.setValue('USER_CONFIG', USER_CONFIG);
            showNotification(`Reset channel page for ${channelHandleURL}.`);
            return;
        }
        if (input === 'DELETE ALL') {
            USER_CONFIG.channelDefaultPages = {};
            await GM.setValue('USER_CONFIG', USER_CONFIG);
            showNotification(`Deleted all saved channel pages.`);
            return;
        }
        if (currentChannelPage === USER_CONFIG.defaultChannelPage) {
            showNotification(`${currentChannelPage} is already the default channel page.`);
            return;
        }

        USER_CONFIG.channelDefaultPages[channelHandleURL] = currentChannelPage;
        await GM.setValue('USER_CONFIG', USER_CONFIG);
        showNotification(`Saved ${currentChannelPage} for ${channelHandleURL}.`);
    }
    ...
    function showNotification(message, reload = false) {
        ...
        overlay.classList.add('CentAnni-overlay', 'active');
    ...
    async function getVideoInfo(playbackspeed = false) {
        let channelName;
        let isCollaborators = false;
        if (!playbackspeed) channelName = watchFlexyElement.querySelector('#channel-name a')?.textContent.trim();
        if (!channelName) {
            const popupContainer = document.querySelector('ytd-app ytd-popup-container.ytd-app');
            const attributedChannel = watchFlexyElement.querySelector('#attributed-channel-name a');
            if (popupContainer && attributedChannel) {
                docElement.classList.add('CentAnni-hide-collabpanel');
                attributedChannel.click();

                await new Promise(resolve => {
                    if (popupContainer.querySelector('.ytListItemViewModelHost')) return resolve();

                    const CollabPanelObserver = new MutationObserver(() => {
                        if (!popupContainer.querySelector('.ytListItemViewModelHost')) return;
                        clearTimeout(CollabPanelObserver.timer);
                        CollabPanelObserver.disconnect();
                        resolve();
                    });

                    CollabPanelObserver.observe(popupContainer, { childList: true, subtree: true });
                    CollabPanelObserver.timer = setTimeout(() => { CollabPanelObserver.disconnect(); resolve(); }, 500);
                });

                const videoCollab = [...document.querySelectorAll('.ytListItemViewModelHost')].map(element => playbackspeed ? element.querySelector('.ytListItemViewModelSubtitle')?.textContent.match(/@([^\s\u2066-\u2069]+)/)?.[1] : element.querySelector('a')?.textContent.trim()).filter(Boolean);

                if (playbackspeed) channelName = videoCollab;
                else {
                    const collabFormatted = videoCollab.length > 2 ? videoCollab.slice(0, -1).join(', ') + ', and ' + videoCollab.at(-1) : videoCollab.join(' and ');
                    channelName = collabFormatted || attributedChannel?.textContent.trim() || 'N/A';
                }
                isCollaborators = true;

                requestAnimationFrame(() => requestAnimationFrame(() => {
                    docBody.click();
                    requestAnimationFrame(() => requestAnimationFrame(() => docElement.classList.remove('CentAnni-hide-collabpanel')));
                }));
            } else channelName = 'N/A';
        }

        if (playbackspeed) return { channelName };
        ...
        return { ytTitle, channelName, uploadDate, videoURL, isCollaborators };
    }
    ...
    const getSummaryWordTarget = (transcript) => {
        ...
        if (l < 6000) return 100;
        if (l < 11000) return 150;
        if (l < 24000) return 200;
        if (l < 44000) return 300;
    ...
    async function selectAndCopyTranscript(target) {
        ...
        const { ytTitle, channelName, uploadDate, videoURL, isCollaborators } = await getVideoInfo();

        let finalText = '';
        let targetUrl = '';
        const author = isCollaborators ? 'Collaborators' : 'Channel';
    ...
    function tabView() {
        ...
        const checkYouTubeColumns = (setYouTubeColumns = false) => {
            if (watchFlexyElement.hasAttribute('is-single-column')) {
                ...
                } else if (!setYouTubeColumns) {
                    docElement.classList.remove('CentAnni-video-tabView');
                    return true;
                }
            }
            return false;
        ...
        const updateMastheadWidth = () => {
            ...
            const columnsRight = watchFlexyElement.querySelector('#secondary').getBoundingClientRect().right;
            const hasRightSpace = docElement.clientWidth - columnsRight > .5;
        ...
        const fullscreenCheck = () => {
            ...
            if (isFullscreen) {
                ...
                requestAnimationFrame(() => requestAnimationFrame(() => {
                    ...
                    updateTabView();
                    if (USER_CONFIG.maxPanelHeight) checkMastheadWidth();
    ...
    async function chapterTitles() {
        ...
        normalContainer.appendChild(containerChapterTitle);
        ...
        }; if (isFullscreen) updateTitleContainer();
    ...
    // helper to get channel playback speed for collaborators
    const collabPlaybackSpeedCheck = async () => {
        const { channelName } = await getVideoInfo(true);
        const savedSpeeds = channelName.map(name => USER_CONFIG.channelPlaybackSpeeds[name]).filter(Boolean);
        const savedSpeed = savedSpeeds.length ? Math.min(...savedSpeeds) : null;
        if (savedSpeed) {
    ...
    async function createPlaybackSpeedController(options = {}) {
        ...
        function initializeSpeed() {
            ...
            else if (isLive || (USER_CONFIG.VerifiedArtist && isMusicVideo)) newUserRate = 1;
    ...
    function keepProgressBarVisible() {
        ...
        updateSegmentsOpacity = () => {
            ...
            for (const seg of cachedSegmentTimes) seg.el.classList.toggle('segment-watched', seg.end <= currentTime + .5);
        };
    ...
    function homeColorCodeVideos() {
        ...
        const homePage = document.querySelector('ytd-browse[page-subtype="home"][role="main"]:not([hidden])');
        if (!homePage) return;
    ...
    async function markLastSeenVideo() {
        ...
        if (newLastSeenID && newLastSeenID !== lastSeenID) await GM.setValue(key, newLastSeenID);
        ...
        const handleBtnClick = () => {
            ...
            waitForElement(selector, (removeLink) => {
                ...
                waitForElement('#confirm-button > yt-button-shape > button', (confirmButton) => {
                    ...
                    if (USER_CONFIG.playlistLinks) setTimeout(() => location.reload(), 800);
                    docElement.classList.remove('CentAnni-playlist-remove-btn-hide-menus');
                });
            });
        };
    ...
    async function playlistDirection() {
        ...
        function getPlaylistInfo() {
            ...
            const success = reverseDirection ? currentVideoIndex === 0 || validDataVideoAbove : validDataVideoBelow;
            return success;
        }
        ...
        function createButtons(reverseDirection) {
            ...
            const BTN_CLASS = watchFlexyElement.querySelector('#secondary #playlist:not([playlist-type="TLPQ"]) #top-level-buttons-computed button')?.className ?? 'ytSpecButtonShapeNextHost ytSpecButtonShapeNextText ytSpecButtonShapeNextMono ytSpecButtonShapeNextSizeM ytSpecButtonShapeNextIconOnlyDefault ytSpecButtonShapeNextEnableBackdropFilterExperiment';
            const ICON_CLASS = watchFlexyElement.querySelector('#secondary #playlist:not([playlist-type="TLPQ"]) #top-level-buttons-computed button > div')?.className ?? 'ytSpecButtonShapeNextIcon ytSpecButtonShapeNextElevatedContent';
        ...
        observer = new MutationObserver(() => {
            ...
            if (selectedItem && nextButton) {
                playlistSelectedVideo = selectedItem;
                if (getPlaylistInfo()) {
                    observer.disconnect();
    ...
    function sortCommentsNewFirst() {
        ...
        function changeSortingToNewestFirst() {
            ...
            dropdownObserver.observe(docElement, { childList: true, subtree: true });
    ...
    const restoreHomeFeedFilterChip = (chipText) => {
        ...
        runInPage(function (targetChipText) {
            const chip = [...document.querySelectorAll('ytd-browse[page-subtype="home"][role="main"]:not([hidden]) #header #chips yt-chip-cloud-chip-renderer')].find(chip => chip.querySelector('.ytChipShapeChip')?.textContent?.trim() === targetChipText);
            chip?.onTap?.();
        }, chipText);
    };
    ...
    function getHomeCategoryKeywords(locale) {
        switch (locale) {
            ...
            case 'zh': return { live: ['人正在观看', '直播'], upcoming: ['正在等待', '预定发布时间'], streamed: ['直播时间'] };
